...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://tempuri.org/" xmlns:s1="http://microsoft.com/wsdl/types/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" targetNamespace="http://tempuri.org/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://tempuri.org/">
      ...
      <s:element name="GetMyComplexType4">
        <s:complexType />
      </s:element>
      <s:element name="GetMyComplexType4Response">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetMyComplexType4Result" type="tns:MyComplexType4" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="MyComplexType4">
        <s:complexContent mixed="false">
          <s:extension base="tns:MyComplexType3">
            <s:sequence>
  ...
  <wsdl:message name="GetMyComplexType4SoapIn">
    <wsdl:part name="parameters" element="tns:GetMyComplexType4" />
  </wsdl:message>
  <wsdl:message name="GetMyComplexType4SoapOut">
    <wsdl:part name="parameters" element="tns:GetMyComplexType4Response" />
  </wsdl:message>
  ...
  <wsdl:portType name="MyWebService2Soap">
    <wsdl:operation name="GetMyComplexType4">
      <wsdl:input message="tns:GetMyComplexType4SoapIn" />
      <wsdl:output message="tns:GetMyComplexType4SoapOut" />
    </wsdl:operation>
  ...
  <wsdl:binding name="MyWebService2Soap" type="tns:MyWebService2Soap">
    <soap:binding transport="http://schemas.xmlsoap.org/soap/http" />
    <wsdl:operation name="GetMyComplexType4">
      <soap:operation soapAction="http://tempuri.org/GetMyComplexType4" style="document" />
      <wsdl:input>
  ...
  <wsdl:binding name="MyWebService2Soap12" type="tns:MyWebService2Soap">
    <soap12:binding transport="http://schemas.xmlsoap.org/soap/http" />
    <wsdl:operation name="GetMyComplexType4">
      <soap12:operation soapAction="http://tempuri.org/GetMyComplexType4" style="document" />
      <wsdl:input>
  ...
  <wsdl:service name="MyWebService2">
    <wsdl:port name="MyWebService2Soap" binding="tns:MyWebService2Soap">
      <soap:address location=<% SPHttpUtility.AddQuote(SPHttpUtility.HtmlEncode(SPWeb.OriginalBaseUrl(Request)),Response.Output); %> />
    </wsdl:port>
    <wsdl:port name="MyWebService2Soap12" binding="tns:MyWebService2Soap12">
